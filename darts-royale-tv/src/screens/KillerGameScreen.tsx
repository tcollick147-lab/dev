...
export default function KillerGameScreen({ navigation, route }: Props) {
  ...
  const theme = darkMode
    ? {
        ...
        killerPillText: { color: "#FFFFFF", fontSize: 13, fontWeight: "800" },
        killerPillIcon: { color: "#FFFFFF", fontSize: 14, fontWeight: "800" },
...
const styles = StyleSheet.create({
  ...
  killerPillText: { color: "white", fontWeight: "900", fontSize: 16 },
  killerPillIcon: { fontSize: 18, fontWeight: "900" },
